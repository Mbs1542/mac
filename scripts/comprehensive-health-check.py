...
SERVICES = {
    ...
    'authelia': {
        'url': 'https://auth.mbs-home.ddns.net/api/health',
        'container': 'authelia',
        'critical': True,
        'category': 'Security'
    },
    'vaultwarden': {
        'url': 'https://vault.mbs-home.ddns.net/alive',
    ...
    # Media Services
    'jellyfin': {
        'url': 'https://media.mbs-home.ddns.net/health',
        'container': 'jellyfin',
        'critical': False,
        'category': 'Media'
    },
    'sonarr': {
        'url': 'https://sonarr.mbs-home.ddns.net/api/v3/system/status',
        'container': 'sonarr',
        'critical': False,
        'category': 'Media'
    },
    'radarr': {
        'url': 'https://radarr.mbs-home.ddns.net/api/v3/system/status',
        'container': 'radarr',
        'critical': False,
        'category': 'Media'
    },
    'lidarr': {
        'url': 'https://lidarr.mbs-home.ddns.net/api/v1/system/status',
        'container': 'lidarr',
        'critical': False,
        'category': 'Media'
    },
    ...
    # Cloud & Productivity
    'nextcloud': {
        'url': 'https://nextcloud.mbs-home.ddns.net/status.php',
        'container': 'nextcloud',
        'critical': False,
        'category': 'Cloud'
    },
    ...
    # AI & Automation
    'open-webui': {
        'url': 'https://ai.mbs-home.ddns.net/health',
    ...
    # Monitoring
    'prometheus': {
        'url': 'https://prometheus.mbs-home.ddns.net/-/ready',
        'container': 'prometheus',
        'critical': True,
        'category': 'Monitoring'
    },
    'grafana': {
        'url': 'https://monitor.mbs-home.ddns.net/api/health',
        'container': 'grafana',
        'critical': False,
        'category': 'Monitoring'
    },
...
class HomelabHealthChecker:
    ...
    def check_http_endpoint(self, url: str, timeout: int = 10) -> bool:
        ...
        try:
            ...
            # If SSL error, try with verification disabled
            try:
                response = requests.get(url, timeout=timeout, verify=False)
                return response.status_code < 500
            except:
